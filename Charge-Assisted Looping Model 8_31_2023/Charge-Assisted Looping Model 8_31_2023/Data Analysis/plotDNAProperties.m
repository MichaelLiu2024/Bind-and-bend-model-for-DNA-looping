function plotDNAProperties(planarCoordsNoProt, planarCoordsWithProt, type, DNA, AGENT)
%%  Summary
%
%   Inputs:
...
%       Store radii
        ...
        if(strcmp(type,'Simulated'))
                    noProtCurvatures(i, 1:length(pc)) = LineCurvature2DSmooth(DNA, AGENT, pc);
        end
    end
...
%       Store radii
        ...
        if(strcmp(type,'Simulated'))
                    withProtCurvatures(i, 1:length(pc)) = LineCurvature2DSmooth(DNA, AGENT, pc);
        end
    end
