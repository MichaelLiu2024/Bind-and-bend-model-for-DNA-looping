...
%           kPlanar = multiply this by the persistence length to get the threshold distance along the contour. Must be greater than threshold distance to be a loop. 
%           Klinear = multiply this by the persistence length to get the
%           threshold distance between two DNA strands. Less than this
%           distance to be a loop.
...
%           each protamine binding event
%           displayMolecules: Whether or not to display each protamine
%           molecule bound to the DNA
%
%           SIM.power = 0.05;
%           SIM.numTrials = 5;
