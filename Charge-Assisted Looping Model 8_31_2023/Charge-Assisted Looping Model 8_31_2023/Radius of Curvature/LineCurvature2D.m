...
%   polygons to the points. Then it calculates the analytical curvature
%   from the polygons.
%
%   k = LineCurvature2D(Vertices)
% 
%   inputs,
%       Vertices: A 1 x M list of line points as complex coordinates.
%
%   outputs,
%       k: 1 x M list of curvature values
%
%   Function is written by D.Kroon University of Twente (August 2011)

%%  Code

Vertices=[real(Vertices)', imag(Vertices)'];
